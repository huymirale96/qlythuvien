...
namespace QLThuVien
{
    public partial class frmNhanVien : Form
    {
        ...
        private void data_bingding()
        {
            ...
            txtchucvunv.DataBindings.Add("Text",dgvttnv.DataSource,"ChucVu");
            txtDiachinv.DataBindings.Add("Text",dgvttnv.DataSource,"DiaChi");
            txtDienthoainv.DataBindings.Add("Text",dgvttnv.DataSource, "Sdt");
        }
        ...
        private void luunhanvien()
        {
            ...
            cmd.Parameters.AddWithValue("@ChucVu", chucvunv);
